...
Welcome to my portfolio! Here you will find three end-to-end projects demonstrating my skills in **Python (Pandas, NumPy)**, **Data Cleaning**, **EDA**, and **Power BI**.

---

## 1. 🏦 [Banking Risk Analysis](./Banking-Risk-Analysis)
...
## 3. 🌍 [Regional Sales Analysis](./Regional-Sales-Analysis)
